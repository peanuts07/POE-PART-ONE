...
namespace GADE112_POE_PART_1
{
    internal class Map
    {
       ...
       public static string [,] map; // random size of  map 
        ...
        public static void UpdateVison() // enemy 
        {

                vision[0] = positionXE - 1; // west
                vision[1] = positionXE + 1; // east
                vision[2] = positionYE - 1; // north
                vision[3] = positionYE + 1; // south
        ...
        public static void FillMap()
        {
            ...
            for (int row = 0; row < 10; row++)
            {
                ...
                for (int col = 0; col < 10; col++)
                {
                    ...
                    else if (row == positionXE && col == positionYE) // need to make sure H and e are not the same
                    {
